...
@Autonomous(name = "Red Side Autonomous OpMode - Cube Only")
public class RedAutonomousCube extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            drive.driveStraight(375, motorPower);
            //drive.resetMotors();
            Thread.sleep(300);
            ...
            drive.driveReverse(410, motorPower);
            //drive.resetMotors();
